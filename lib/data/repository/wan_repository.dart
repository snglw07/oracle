...
import 'package:wbyq/data/api/apis.dart';
import 'package:wbyq/data/net/dio_util.dart';
import 'package:wbyq/data/protocol/models.dart';
...
class WanRepository {
  Future<List<BannerModel>> getBanner() async {
    ...
    if (baseResp.code != Constant.STATUS_SUCCESS) {
      return new Future.error(baseResp.msg as Object);
    }
  ...
  Future<List<ReposModel>> getArticleListProject(int page) async {
    ...
    if (baseResp.data != null) {
      var comData = ComData.fromJson(baseResp.data!);
  ...
  Future<List<ReposModel>> getWxArticleList(
