...
class MyJzUploadPage extends StatefulWidget {
  const MyJzUploadPage({super.key});

  @override
  MyJzUploadPageState createState() => MyJzUploadPageState();
}

class MyJzUploadPageState extends State<MyJzUploadPage>
  ...
  doExecQuery() async {
    ...
    try {
      ...
      res =
          await WbNetApi.exec('wbyq.yqfk.jzupload.query', params: _queryParams);
      Notify.dismissAll();
    } catch (e) {}
                      ...
                      body: Column(children: <Widget>[
                        ...
                        Container(
                            ...
                            child: ListTile(
                              ...
                              Expanded(
                                  flex: 3,
                                  child: Text(item['address'] ?? '' as dynamic,
                                      style: const TextStyle(fontSize: 15),
                                      overflow: TextOverflow.ellipsis))
                            ]))),
                        Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: const Text("就诊上报记录"), centerTitle: true),
        body: Column(children: <Widget>[
